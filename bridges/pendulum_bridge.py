...
from lcm_types.robot_lcm import simple_pendulum_state_t, simple_pendulum_control_t
from utils import *

class SimplePendulumBridge(Lcm2MujocoBridge):
    ...
    def update_motor_cmd(self):
        return super().update_motor_cmd()

    def lowStateHandler(self, channel, data):
        if self.mj_data is None:
            return
        msg = simple_pendulum_state_t.decode(data)
